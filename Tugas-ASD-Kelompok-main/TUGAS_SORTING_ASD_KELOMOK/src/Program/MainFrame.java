...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        beforeSortPanel = new javax.swing.JPanel();
        ...
        afterSortPanel = new javax.swing.JPanel();
        ...
        jLabel1.setText("SORTING ALGORITHM");

        beforeSortPanel.setBackground(new java.awt.Color(255, 153, 102));
        beforeSortPanel.setForeground(new java.awt.Color(255, 153, 102));

        javax.swing.GroupLayout beforeSortPanelLayout = new javax.swing.GroupLayout(beforeSortPanel);
        beforeSortPanel.setLayout(beforeSortPanelLayout);
        beforeSortPanelLayout.setHorizontalGroup(
            beforeSortPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(beforeSortPanelLayout.createSequentialGroup()
                .addContainerGap()
        ...
        beforeSortPanelLayout.setVerticalGroup(
            beforeSortPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, beforeSortPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(beforeSortPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(b1)
        ...
        afterSortPanel.setBackground(new java.awt.Color(255, 153, 102));
        afterSortPanel.setForeground(new java.awt.Color(255, 102, 51));
        ...
        javax.swing.GroupLayout afterSortPanelLayout = new javax.swing.GroupLayout(afterSortPanel);
        afterSortPanel.setLayout(afterSortPanelLayout);
        afterSortPanelLayout.setHorizontalGroup(
            afterSortPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(afterSortPanelLayout.createSequentialGroup()
                .addContainerGap()
        ...
        afterSortPanelLayout.setVerticalGroup(
            afterSortPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, afterSortPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(afterSortPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(a1)
        ...
        jLabel2.setText("After Sorting :");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(102, 102, 102));
        jLabel3.setText("Before Sorting :");

        buttonGroup1.add(ascRadioButton);
        ascRadioButton.setText("Ascendants");

        buttonGroup1.add(descRadioButton);
        descRadioButton.setText("Descendants");

        sortbutton.setBackground(new java.awt.Color(255, 153, 102));
        sortbutton.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        comboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Insertion Sort", "Bubble Sort", "Selection Sort" }));
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(afterSortPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, mainPanelLayout.createSequentialGroup()
                        .addComponent(descRadioButton)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(ascRadioButton)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(sortbutton, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(3, 3, 3))
                    .addGroup(mainPanelLayout.createSequentialGroup()
                    ...
                    .addComponent(beforeSortPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addComponent(beforeSortPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(afterSortPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(45, 45, 45))
        );
    ...
    private void sortbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sortbuttonActionPerformed
        ...
        boolean sortAscending = ascRadioButton.isSelected();
        int[] array = inputArray();

        if (array != null) {
            switch (selectedSort) {
                case "Bubble Sort":
                    sort.bubbleSort(array, sortAscending);
                    break;
                case "Insertion Sort":
                    sort.insertionSort(array, sortAscending);
                    break;
                case "Selection Sort":
                    sort.selectionSort(array, sortAscending);
                    break;
            }
            displayArray(array);
        } else {
            javax.swing.JOptionPane.showMessageDialog(this, "Please enter valid integers in all fields.");
        }
    ...
    public int[] inputArray() {
        ...
        try {
            array[0] = Integer.parseInt(b1.getText());
            array[1] = Integer.parseInt(b2.getText());
            array[2] = Integer.parseInt(b3.getText());
            array[3] = Integer.parseInt(b4.getText());
            array[4] = Integer.parseInt(b5.getText());
            array[5] = Integer.parseInt(b6.getText());
            array[6] = Integer.parseInt(b7.getText());
            array[7] = Integer.parseInt(b8.getText());
            array[8] = Integer.parseInt(b9.getText());
            array[9] = Integer.parseInt(b10.getText());
    ...
    public void displayArray(int[] array) {
        ...
        a7.setText(String.valueOf(array[6]));
        a8.setText(String.valueOf(array[7]));
        a9.setText(String.valueOf(array[8]));
        a10.setText(String.valueOf(array[9]));
    }
    ...
    private javax.swing.JPanel afterSortPanel;
    ...
    private javax.swing.JPanel beforeSortPanel;
